...
namespace Xigen\NewProduct\Block\Widget;

/**
 * Xigen NewProduct Widget block class
 */
class NewProduct extends \Magento\Catalog\Block\Product\NewProduct implements \Magento\Widget\Block\BlockInterface
{
    ...
    {
        return $this->_getNewProductProductsCollection();
    }
     ...
     * @return \Magento\Catalog\Model\ResourceModel\Product\Collection|Object|\Magento\Framework\Data\Collection
     */
    protected function _getNewProductProductsCollection()
    {
        ...
        if ($this->showPager()) {
            if (!$this->_pager) {
                $this->_pager = $this->getLayout()->createBlock(
                    ...
                    'widget.newproduct.product.list.pager'
                );
